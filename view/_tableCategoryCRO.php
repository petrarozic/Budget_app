            ...
            <?php
              if( empty($inc_catList) )
                ...
                foreach($inc_catList as $t){
                  echo '<tr>';
                  echo '<td>'.$t.'</td>';
                  echo '<td><button class="IconButtonE" id="EditIcon" name="Income" data-toggle="modal" data-target="#EditCategoryCRO" value="'.$t.'" ><i class="far fa-edit"></i></button></td>';
            ...
            <?php
              if( empty($exp_catList) )
                ...
                foreach($exp_catList as $t){
                  echo '<tr>';
                  echo '<td>'.$t.'</td>';
                  echo '<td><button class="IconButtonE" id="EditIcon" name="Expense" data-toggle="modal" data-target="#EditCategoryCRO" value="'.$t.'" ><i class="far fa-edit"></i></button></td>';
